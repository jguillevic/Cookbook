...
namespace Cookbook.Service
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            actions.Add(ServiceConfiguration.Instance.RecipeSummaryRoute, RecipeSummaryService.Process);
            ...
            actions.Add(ServiceConfiguration.Instance.IngredientSummaryRoute, IngredientSummaryService.Process);
            actions.Add(ServiceConfiguration.Instance.MeasureRoute, MeasureService.Process);
            actions.Add(ServiceConfiguration.Instance.MeasureSummaryRoute, MeasureSummaryService.Process);
